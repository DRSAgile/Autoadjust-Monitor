...
; if the CSV file only has information for the 365 day when current year is a leap one, then the script for the 366th day will again use information for the 365th day
